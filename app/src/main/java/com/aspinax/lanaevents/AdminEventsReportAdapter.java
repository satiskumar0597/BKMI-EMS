...
public class AdminEventsReportAdapter extends RecyclerView.Adapter<AdminEventsReportAdapter.ViewHolder> {
    ...
    AdminEventsReportAdapter(Context context, List<Event> eventList) {
    ...
    @NonNull
    @Override
    public AdminEventsReportAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdminEventsReportAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.banner_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), AdminEventReportDetails.class);
