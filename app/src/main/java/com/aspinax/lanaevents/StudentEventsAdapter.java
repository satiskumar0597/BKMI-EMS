...
public class StudentEventsAdapter extends RecyclerView.Adapter<com.aspinax.lanaevents.StudentEventsAdapter.ViewHolder> {
        ...
        StudentEventsAdapter(Context context, List<Event> eventList) {
        ...
        @NonNull
        @Override
        public com.aspinax.lanaevents.StudentEventsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            Context context = parent.getContext();
            LayoutInflater inflater = LayoutInflater.from(context);
            View eItemView = inflater.inflate(R.layout.item_event, parent, false);
            return new com.aspinax.lanaevents.StudentEventsAdapter.ViewHolder(eItemView);
        }

        @Override
        public void onBindViewHolder(com.aspinax.lanaevents.StudentEventsAdapter.ViewHolder viewHolder, int position) {
            ...
            viewHolder.banner_image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getContext(), StudentEventDetails.class);
