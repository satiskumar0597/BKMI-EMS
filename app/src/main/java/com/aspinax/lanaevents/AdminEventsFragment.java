...
public class AdminEventsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_admin_events, container, false);
        ...
        db = new Database(new AsyncResponse() {
            ...
            public void resultHandler(Map<String, Object> result, int resultCode) {
                ...
                if (resultCode == 0) {
                    ...
                    AdminEventsAdapter eventsAdapter = new AdminEventsAdapter(getContext(), eventList);
