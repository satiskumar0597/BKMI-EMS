...
public class AdminEventsReportFragment extends Fragment {
    private Database db;
    public AdminEventsReportFragment() {}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_admin_report, container, false);
        ...
        db = new Database(new AsyncResponse() {
            ...
            public void resultHandler(Map<String, Object> result, int resultCode) {
                ...
                if (resultCode == 0) {
                    ...
                    AdminEventsReportAdapter eventsAdapter = new AdminEventsReportAdapter(getContext(), eventList);
                    ...
                    db.filterWithOneFieldAndCompareLess("events", "userId", mAuth.getCurrentUser().getUid(), "end", getTodayDate(), Event.class, 1);
                } else {
        ...
        db.filterWithOneFieldAndCompareGreater("events", "userId", mAuth.getCurrentUser().getUid(), "end", getTodayDate(), Event.class,0);
        return view;
    }
}
