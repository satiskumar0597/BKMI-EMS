...
public class StudentDiscoverEventsAdapter extends RecyclerView.Adapter<StudentDiscoverEventsAdapter.ViewHolder> {
    ...
    StudentDiscoverEventsAdapter(Context context, List<Event> eventList) {
    ...
    @NonNull
    @Override
    public StudentDiscoverEventsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(StudentDiscoverEventsAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.banner_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), StudentDiscoverEventDetails.class);
