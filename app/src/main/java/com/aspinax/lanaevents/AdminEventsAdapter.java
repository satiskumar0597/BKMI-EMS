...
public class AdminEventsAdapter extends RecyclerView.Adapter<AdminEventsAdapter.ViewHolder> {
    ...
    AdminEventsAdapter(Context context, List<Event> eventList) {
    ...
    @NonNull
    @Override
    public AdminEventsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdminEventsAdapter.ViewHolder viewHolder, int position) {
